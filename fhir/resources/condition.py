...
class Condition(domainresource.DomainResource):
    ...
    evidence: typing.List[CodeableReference] = Field(
        None,
        alias="evidence",
    ...
    participant: typing.List["ConditionParticipant"] = Field(
        None,
        alias="participant",
        title=(
    ...
    stage: typing.List["ConditionStage"] = Field(
        None,
        alias="stage",
...
class ConditionParticipant(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("ConditionParticipant", const=True)
