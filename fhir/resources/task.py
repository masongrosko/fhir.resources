...
class Task(domainresource.DomainResource):
    ...
    performer: typing.List["TaskPerformer"] = Field(
        None,
        alias="performer",
    ...
    requestedPerformer: typing.List[CodeableReference] = Field(
        None,
...
class TaskPerformer(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("TaskPerformer", const=True)
