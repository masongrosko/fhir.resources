...
class NutritionOrder(domainresource.DomainResource):
    ...
    performer: typing.List[CodeableReference] = Field(
        None,
        alias="performer",
...
class NutritionOrderEnteralFormula(backboneelement.BackboneElement):
    ...
    additive: typing.List["NutritionOrderEnteralFormulaAdditive"] = Field(
        None,
        alias="additive",
    ...
    baseFormulaType: CodeableReference = Field(
        None,
    ...
    deliveryDevice: typing.List[CodeableReference] = Field(
        None,
...
class NutritionOrderEnteralFormulaAdditive(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("NutritionOrderEnteralFormulaAdditive", const=True)
...
class NutritionOrderEnteralFormulaAdministration(backboneelement.BackboneElement):
    ...
    schedule: "NutritionOrderEnteralFormulaAdministrationSchedule" = Field(
        None,
        alias="schedule",
...
class NutritionOrderEnteralFormulaAdministrationSchedule(
    ...
    asNeededFor: CodeableConcept = Field(
        None,
        alias="asNeededFor",
    ...
    timing: typing.List[Timing] = Field(
        None,
        alias="timing",
...
class NutritionOrderOralDiet(backboneelement.BackboneElement):
    ...
    schedule: "NutritionOrderOralDietSchedule" = Field(
        None,
        alias="schedule",
...
class NutritionOrderOralDietSchedule(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("NutritionOrderOralDietSchedule", const=True)
...
class NutritionOrderSupplement(backboneelement.BackboneElement):
    ...
    schedule: "NutritionOrderSupplementSchedule" = Field(
        None,
        alias="schedule",
...
class NutritionOrderSupplementSchedule(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("NutritionOrderSupplementSchedule", const=True)
