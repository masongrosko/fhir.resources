...
class Measure(domainresource.DomainResource):
    ...
    scoringUnit: CodeableConcept = Field(
        None,
        alias="scoringUnit",
        title="What units?",
        description=(
    ...
    term: typing.List["MeasureTerm"] = Field(
        None,
        alias="term",
...
class MeasureGroupPopulation(backboneelement.BackboneElement):
    ...
    aggregateMethod: CodeableConcept = Field(
        None,
    ...
    groupDefinition: Reference = Field(
        None,
...
class MeasureTerm(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("MeasureTerm", const=True)
