...
class TestScript(domainresource.DomainResource):
    ...
    scope: typing.List["TestScriptScope"] = Field(
        None,
        alias="scope",
...
class TestScriptScope(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("TestScriptScope", const=True)
    ...
    conformance: CodeableConcept = Field(
        None,
        alias="conformance",
...
class TestScriptSetupActionAssert(backboneelement.BackboneElement):
    ...
    requirement: typing.List["TestScriptSetupActionAssertRequirement"] = Field(
        None,
        alias="requirement",
...
class TestScriptSetupActionAssertRequirement(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("TestScriptSetupActionAssertRequirement", const=True)
