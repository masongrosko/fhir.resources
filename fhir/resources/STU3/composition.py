...
class Composition(domainresource.DomainResource):
    ...
    relatesTo: typing.List["CompositionRelatesTo"] = Field(
        None,
        alias="relatesTo",
...
class CompositionAttester(backboneelement.BackboneElement):
    ...
    mode__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = (
...
class CompositionRelatesTo(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("CompositionRelatesTo", const=True)
