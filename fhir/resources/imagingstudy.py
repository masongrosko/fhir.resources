...
class ImagingStudy(domainresource.DomainResource):
    ...
    procedure: typing.List[CodeableReference] = Field(
        None,
        alias="procedure",
...
class ImagingStudySeries(backboneelement.BackboneElement):
    ...
    performer: typing.List["ImagingStudySeriesPerformer"] = Field(
        None,
        alias="performer",
...
class ImagingStudySeriesPerformer(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("ImagingStudySeriesPerformer", const=True)
