...
class Dosage(backbonetype.BackboneType):
    ...
    asNeededFor: typing.List[CodeableConcept] = Field(
        None,
        alias="asNeededFor",
    ...
    doseAndRate: typing.List["DosageDoseAndRate"] = Field(
        None,
        alias="doseAndRate",
        title=(
    ...
    maxDosePerPeriod: typing.List[Ratio] = Field(
        None,
...
class DosageDoseAndRate(element.Element):
    ...
    resource_type: str = Field("DosageDoseAndRate", const=True)
