...
class ValueSetExpansion(backboneelement.BackboneElement):
    ...
    property: typing.List["ValueSetExpansionProperty"] = Field(
        None,
        alias="property",
...
class ValueSetExpansionContains(backboneelement.BackboneElement):
    ...
    property: typing.List["ValueSetExpansionContainsProperty"] = Field(
        None,
        alias="property",
...
class ValueSetExpansionContainsProperty(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("ValueSetExpansionContainsProperty", const=True)
    ...
    subProperty: typing.List["ValueSetExpansionContainsPropertySubProperty"] = Field(
        None,
        alias="subProperty",
...
class ValueSetExpansionContainsPropertySubProperty(backboneelement.BackboneElement):
    ...
    resource_type: str = Field(
        "ValueSetExpansionContainsPropertySubProperty", const=True
    )
...
class ValueSetExpansionProperty(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("ValueSetExpansionProperty", const=True)
...
class ValueSetScope(backboneelement.BackboneElement):
    ...
    resource_type: str = Field("ValueSetScope", const=True)
